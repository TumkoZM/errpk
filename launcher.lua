...
local function drawStatic()
    ...
    buffer.drawText(22, 6, 0xFFFFFF, '│')
    buffer.drawText(22, 7, 0xFFFFFF, '│')
    buffer.drawText(22, 8, 0xFFFFFF, '│')
    buffer.drawText(22, 9, 0xFFFFFF, '│')
    buffer.drawText(22, 10, 0xFFFFFF, '│')
    buffer.drawText(22, 11, 0xFFFFFF, '│')
    buffer.drawText(22, 12, 0xFFFFFF, '│')
    buffer.drawText(22, 13, 0xFFFFFF, '│')
    buffer.drawText(22, 14, 0xFFFFFF, '│')
    buffer.drawText(22, 15, 0xFFFFFF, '│')
    buffer.drawText(22, 16, 0xFFFFFF, '│')
    buffer.drawText(22, 17, 0xFFFFFF, '│')
    buffer.drawText(22, 18, 0xFFFFFF, '│')
    buffer.drawText(22, 19, 0xFFFFFF, '│')
    buffer.drawText(22, 20, 0xFFFFFF, '│')
    buffer.drawText(22, 21, 0xFFFFFF, '│')
